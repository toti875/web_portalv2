			...
			<div className="row justify-content-center">
				<div className="col-12">
					...
					<p style={{ fontSize: '1.6rem' }}>
						Fortem Token<strong style={{ color: '#fff' }}> (CX)</strong> IEO Round 2 starts on 30th of January!
					</p>
					<p style={{ fontSize: '1.6rem' }}>
						Pre-Launch: 30/01/2021, 13:00 pm, UTC - 10/02/2021, 13:00 pm, UTC | $0.05 USD |{' '}
