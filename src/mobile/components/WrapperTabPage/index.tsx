...
interface WrapperTabPageProps {
	...
	filterState: 'upcoming' | 'running' | 'all';
	setFilterState: React.Dispatch<React.SetStateAction<'upcoming' | 'running' | 'all'>>;
			...
			<div className="container td-mobile-cpn-wrapper-tab-page__header">
				<div className="row">
					<div className="col-12">
						<h3 className="td-mobile-cpn-wrapper-tab-page__header__h3">{title}</h3>
					</div>
				</div>
				<div className="td-mobile-cpn-wrapper-tab-page__header__search">
					<input
