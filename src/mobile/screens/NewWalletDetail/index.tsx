	...
	return (
		<div className="td-mobile-wallet-detail">
			<div className="td-mobile-wallet-detail__header">
				...
				<h5 className="td-mobile-wallet-detail__header__title">Informações da carteira</h5>
			...
			<div className="td-mobile-wallet-detail__panel">
				...
				<div className="td-mobile-wallet-detail__panel__row">
					<span className="td-mobile-wallet-detail__panel__row__text">Disponível</span>
					<span className="td-mobile-wallet-detail__panel__row__number">{wallet?.balance}</span>
				</div>
				<div className="td-mobile-wallet-detail__panel__row">
					<span className="td-mobile-wallet-detail__panel__row__text">Bloqueado (em uso)</span>
			...
			<div className="td-mobile-wallet-detail__market">
				<span className="td-mobile-wallet-detail__market__title">Negociar</span>
