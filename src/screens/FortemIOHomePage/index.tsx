...
<>
		...
		{BannerData.map((data, index) => (
			<div key={1} className="single-slide">
				<div className="bg-overlay bg_image" style={{ width: '100vw', height: '80vh', backgroundPosition: '1% 80%',}}>
						...
						<div className="row row--30 align-items-center">
							<div className="col-lg-12">
								<div className="align-items-center justify-items-center" style={{display: 'flex', justifyContent: 'center'}}>
										<h3 className="description justify-center animate_flash" style={{fontFamily: 'Alliance1', fontSize: '38.5px', fontWeight: 'bold', justifyContent: 'center', position: 'absolute', left: '80px', top: '-420px', color: '#f5f5f5', display: 'flex',  width: '50vw', }}> Fortem ONE é a plataforma especializada em  </h3>
										<br/>
										<h3  className=" animate__animated animate__bounce animate__animated animate_flash" style={{opacity: '0.64', fontFamily: 'Alliance1', fontSize: '32px', fontWeight: 'bold', position: 'absolute', left: '80px', top: '60%', width: '50vw', color: '#1EDED0'}} > 
										<Typed
                                            strings={[
                                                "ativos digitais",
												"melhores créditos",
										...
										<Zoom interval={10000} delay={10000} forever={false} duration={8000}>
											<h3 className="description justify-center animate__animated animate__bounce" style={{position: 'absolute',  top: '-220px', left: '84px',  display: 'flex', fontSize: '20px', width: '70vw', }}> {data.description}</h3>
										</Zoom>
