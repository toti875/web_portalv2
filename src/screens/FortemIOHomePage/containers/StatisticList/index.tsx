...
export const StatisticList = React.memo((props: StatisticListProps) => {
	...
	const getTotalValue = () => {
		const totalVolume = markets.reduce((volume, curr) => {
			//const price = _.find(currencies, { id: curr.quote_unit })?. || 0;
			const price = 0;
		...
		<div className="home-statistic-list">
			<div className="d-flex justify-content-between align-items-center ">
				<div className="statistic__item">
					...
					<div className="statistic__item-label">Coins xxx</div>
				</div>
				<div className="statistic__item">
					<div className="statistic__item-amount">
						{/* <CountUp
					...
					<div className="statistic__item-label">Markets xxx</div>
				</div>
				<div className="statistic__item">
				...
				<div className="statistic__item">
					...
					<div className="statistic__item-label">Users</div>
				</div>
			</div>
		</div>
	);
