...
class EmailVerificationComponent extends React.Component<Props> {
	public componentDidMount() {
		setDocumentTitle('Confirme seu email');
			...
			<div className="pg-emailverification-container">
				<div className="pg-emailverification">
					...
					<div className="pg-emailverification-body">
						...
						{!isMobileDevice && (
							<div className="pg-emailverification-body-container">
								{emailVerificationLoading ? (
									...
									<button className="pg-emailverification-body-container-button" onClick={this.handleClick}>
										{button}
									</button>
								)}
							</div>
						...
						{isMobileDevice && (
							<div className="pg-emailverification-body-container">
								<Button block={true} type="button" onClick={this.handleClick} size="lg" variant="primary">
