...
export const pt = {
	...
	'page.body.wallets.tabs.withdraw.content.fee': 'Taxa de transação',
	'page.body.wallets.tabs.withdraw.content.total': 'Montante a receber',
	...
	'page.body.wallets.beneficiaries.title': 'Endereço de saque',
