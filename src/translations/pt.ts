...
export const pt = {
	...
	'page.body.trade.header.yours': 'Seus trades',
 ...
 Caso você perca sua Chave Privada, desative a Chave de Acesso e gere uma nova Chave de API.`,
	...
	'success.identity.accepted': 'Cadastro atualizado com sucesso',
	'success.withdraw.action': 'Solicitação de saque recebida pela Fortem',
	...
	'success.message.sent': 'Email enviado',
...
'page.homepage.banner.title': 'The Global Cryptocurrency Exchange',
'page.homePage.banner.subtitle': 'Making Crypto Trading Easier',
'page.homePage.banner.btn.trade': 'Trade Now',
'page.homePage.banner.btn.register': 'Register Now',
'page.homePage.banner.btn.register.placeholder': 'Enter Your Email Address',
'page.homePage.btn.more': 'More',
'page.homePage.marketOverview.title': 'Market Overview',
'page.homePage.marketOverview.subtitle': 'Crypto market leaderboard express',
'page.homePage.marketOverview.TopGainers': 'Maiores altas',
'page.homePage.marketOverview.TopLosers': 'Maiores baixas',
'page.homePage.marketOverview.ValueLeaders': 'Maiores volumes',
'page.homePage.marketOverview.NewCoins': 'Novos tokens',
'page.homePage.marketOverview.search.placeholder': 'Search Token/Coin',
'page.homePage.marketOverview.searchNotFound.text': 'No relevant coin or token was found',
'page.homePage.marketOverview.apply': 'Apply for listing',
'page.homePage.marketOverview.table.header.Name': 'Name',
'page.homePage.marketOverview.table.header.LastPrice': 'Last Price',
'page.homepage.marketOverview.table.header.Change': 'Variação',
'page.homePage.marketOverview.table.header.Value': 'Preço',
'page.homepage.marketOverview.table.header.volume': 'Volume',
'page.homepage.marketOverview.table.header.Lowest': 'Menor',
'page.homepage.marketOverview.table.header.Highest': 'Maior',
'page.homepage.marketOverview.table.header.Price': 'Preço',
'page.homepage.marketOverview.table.header.Market': 'Market',
'page.homepage.marketOverview.btn.trade.text': 'Trade',
'page.homepage.statistic.coins': 'Coins',
'page.homepage.statistic.Markets': 'Markets',
'page.homepage.statistic.User': 'Users Active',
'page.homepage.download.title': 'Compatible With Multiple Devices',
'page.homepage.download.subtitle': 'Trade Cryptos, Anytime, Anywhere',
'page.homepage.download.description': 'PNL Analysis At a Glance, Deposit and Withdraw With Safety and Convenience',
'page.homepage.introduce.title': 'In Octium, Trade With Safety and Convenience',
'page.homepage.introduce.subtitle': 'Delivering crypto trading services to 200+ countries and regions',
'page.homepage.introduce.item1.title': 'Diversified Trading Selection',
'page.homepage.introduce.item1.subtitle': 'Gather quality crypto assets and explore investment opportunities one step ahead',
'page.homepage.introduce.item2.title': 'Serving Global Market',
'page.homepage.introduce.item2.subtitle':
	'Provide multilingual support for global crypto tradersGather quality crypto assets and explore investment opportunities one step ahead',
'page.homepage.introduce.item3.title': 'Innovative Quality Assets',
'page.homepage.introduce.item3.subtitle':
	'Safeguard assets with multiple security strategies, 100% reserve and payment guarantee',
'page.homepage.introduce.item4.title': 'Full-Dimensional Security Protection',
'page.homepage.introduce.item4.subtitle':
	'Meet the desideration of diverse trading and asset management in Spot, Margin, Futures, AMM, Financial services, etc.	',
'page.homepage.services.title': 'More Services',
'page.homepage.services.item1.title': 'Octium Ambassador',
'page.homepage.services.item1.description': 'Become a Octium Ambassador and get up to 50% referral rewards',
'page.homepage.services.item2.title': 'Octium Partner',
'page.homepage.services.item2.description': 'Join us to build a global business ecosystem',
'page.homepage.services.item3.title': 'Market Makers',
'page.homepage.services.item3.description':
	'Enjoy exclusive privileges such as discount rates, interest-free crediting, stable API services, etc.',
'page.homepage.services.item4.title': 'Apply for Token Listing',
'page.homepage.services.item4.description':
	'The application channel for listing is open for every project via self-submission',

'page.homepage.footer.text': 'Explore The Crypto World Right Away',
'page.homepage.footer.btn.trade': 'Start Trading',

// new homepage
'page.homePage.banner.title.sale': 'SALE Round TWO START IN',
'page.homePage.banner.title.round': 'Octium in Sale Round TWO',
'page.homePage.banner.title.presale': 'Octium PRESALE ROUND TWO',
...
'page.homePage.btn.buy': 'Buy Octium',
'page.homePage.btn.buyList': 'Buyer List',
'page.homePage.download.download': 'Download',
'page.homePage.download.name': 'Octium',
'page.homePage.download.title': ' Trade BTC, CTXX and many more…',
'page.homePage.feature.title': 'Why join Octium ?',
