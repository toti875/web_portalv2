		...
		<div className="footerDesktop-screen">
			...
			<div className="container-footer-screen">
				<div className="footer d-flex flex-row justify-content-between ">
					...
					<div className="footer__info">
						...
						<p className="footer__info__item">
							<a href="https://fortem.website/api" target="_blank" rel="noopener noreferrer">
			...
			<div>
				...
				<p className="footer__copyright">
					<img src={fortemIcon} style={{width: '13px', marginTop: '-2px'}}/>Fortem ONE Ltda © 2022 Copyright : <a href="https://fortem-one.com.br/"> fortem-one.com.br </a> | | Fortem Technologies Inc © 2018 - 2022 Copyright : <a href="https://fortem.tech/"> fortem.tech </a> 
				</p>
			</div>
		</div>
	);
