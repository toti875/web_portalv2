...
class ProfileVerificationComponent extends React.Component<Props> {
    ...
    public renderProgressBarStep = (step: string, index: number, labels: Label[]) => {
        ...
        switch (targetLabelStatus) {
            case 'verified':
                return (
                    <div className="pg-profile-page2-verification__progress-bar__step pg-profile-page2-verification__progress-bar__step--verified">
            ...
            case 'submitted':
                return (
                    <OverlayTrigger
                        ...
                        <div className="pg-profile-page2-verification__progress-bar__step pg-profile-page2-verification__progress-bar__step--pending">
                            <FormattedMessage id={`page.body.profile.verification.progress.level`} />
                            <span>&nbsp;{index + 1}</span>
                            <ClocksIcon />
                        </div>
            ...
            case 'rejected':
                return (
                    <OverlayTrigger
                        ...
                        <div className="pg-profile-page2-verification__progress-bar__step pg-profile-page2-verification__progress-bar__step--rejected">
                            <FormattedMessage id={`page.body.profile.verification.progress.level`} />
                            <span>&nbsp;{index + 1}</span>
                            <CrossIcon />
                        </div>
            ...
            case 'blocked':
                return (
                    <div className="pg-profile-page2-verification__progress-bar__step pg-profile-page2-verification__progress-bar__step--blocked">
                        <FormattedMessage id={`page.body.profile.verification.progress.level`} />
                        <span>&nbsp;{index + 1}</span>
                    </div>
                );
            default:
                return (
                    <OverlayTrigger
                        ...
                        <div className="pg-profile-page2-verification__progress-bar__step pg-profile-page2-verification__progress-bar__step--active">
                            <FormattedMessage id={`page.body.profile.verification.progress.level`} />
                            <span>&nbsp;{index + 1}</span>
                        </div>
                    </OverlayTrigger>
    ...
    public renderProgressBar(labels: Label[]) {
        return (
            <div className="pg-profile-page2-verification__progress-bar">
        ...
        switch (targetLabelStatus) {
            case 'verified':
                return (
                    <div
                        key={index}
                        className="pg-profile-page2-verification__step pg-profile-page2-verification__step--verified">
                        <div className="pg-profile-page2-verification__step__info">
                            <div className="pg-profile-page2-verification__step__info__title">
                                <span>{index + 1}.&nbsp;</span>
                                <FormattedMessage id={`page.body.profile.verification.${labelToCheck}.title`} />
                            </div>
                            <div className="pg-profile-page2-verification__step__info__subtitle">
                                <FormattedMessage id={`page.body.profile.verification.${labelToCheck}.subtitle`} />
                            </div>
                        </div>
                        <div className="pg-profile-page2-verification__step__label pg-profile-page2-verification__step__label--verified">
            ...
            case 'submitted':
                return (
                    <div
                        key={index}
                        className="pg-profile-page2-verification__step pg-profile-page2-verification__step--pending">
                        <div className="pg-profile-page2-verification__step__info">
                            <div className="pg-profile-page2-verification__step__info__title">
                                <span>{index + 1}.&nbsp;</span>
                                <FormattedMessage id={`page.body.profile.verification.${labelToCheck}.title`} />
                        ...
                        <div className="pg-profile-page2-verification__step__label pg-profile-page2-verification__step__label--pending">
            ...
            case 'rejected':
                return (
                    <div
                        key={index}
                        className="pg-profile-page2-verification__step pg-profile-page2-verification__step--rejected">
                        <div className="pg-profile-page2-verification__step__info">
                            <div className="pg-profile-page2-verification__step__info__title">
                                <span>{index + 1}.&nbsp;</span>
                                <FormattedMessage id={`page.body.profile.verification.${labelToCheck}.title`} />
                        ...
                        <OverlayTrigger
                            ...
                            <div className="pg-profile-page2-verification__step__label pg-profile-page-verification__step__label--rejected">
                                <Link to="/confirm">
            ...
            case 'blocked':
                return (
                    <div
                        key={index}
                        className="pg-profile-page2-verification__step pg-profile-page-verification__step--blocked">
                        <div className="pg-profile-page2-verification__step__info">
                            <div className="pg-profile-page2-verification__step__info__title">
                                <span>{index + 1}.&nbsp;</span>
                                <FormattedMessage id={`page.body.profile.verification.${labelToCheck}.title`} />
                        ...
                        <div className="pg-profile-page2-verification__step__button pg-profile-page-verification__step__button--blocked">
                            <Link to="/confirm">
            ...
            default:
                return (
                    <div
                        key={index}
                        className="pg-profile-page2-verification__step pg-profile-page-verification__step--active">
                        <div className="pg-profile-page2-verification__step__info">
                            <div className="pg-profile-page2-verification__step__info__title">
                                <span>{index + 1}.&nbsp;</span>
                                <FormattedMessage id={`page.body.profile.verification.${labelToCheck}.title`} />
                        ...
                        <div className="pg-profile-page2-verification__step__button pg-profile-page-verification__step__button--active">
                            <Link to="/confirm">
                                <FormattedMessage id="page.body.profile.verification.verify" />
                            </Link>
                        </div>
    ...
    public render() {
        ...
        return (
            <div className="pg-profile-page2__box pg-profile-page-verification">
                <h3 className="pg-profile-page2-verification__title">
...
export const ProfileKYC = connect(mapStateToProps, mapDispatchProps)(ProfileVerificationComponent);
