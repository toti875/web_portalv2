...
class Profile2FAComponent extends React.Component<Props, State> {
...
const Profile2FAConnected = injectIntl(connect(mapStateToProps, mapDispatchToProps)(Profile2FAComponent));
// tslint:disable-next-line:no-any
const Profile2FA = withRouter(Profile2FAConnected as any);
