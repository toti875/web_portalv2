...
class ProfileInfoComponent extends React.Component<Props, State> {
...
const ProfileAuthDetailsConnected = injectIntl(connect(mapStateToProps, mapDispatchToProps)(ProfileInfoComponent));
// tslint:disable-next-line:no-any
const ProfileInfo = withRouter(ProfileAuthDetailsConnected as any);
