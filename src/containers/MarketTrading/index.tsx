			...
			<SearchBlockStyle className="d-flex">
				...
				<div className="select-wrapper flex-fill d-flex align-items-center justify-content-center">
					...
					>
						...
						<label className="d-flex align-items-center mb-0 mr-2" style={{fontSize: '13px', marginRight: '5px'}}>Variação</label>
					</div>
					<div
						className="select-item d-flex align-items-center justify-content-center h-100"
					...
					>
						...
						<label className="d-flex align-items-center mb-0 mr-2" style={{fontSize: '13px'}}>Volume</label>
					</div>
				</div>
			</SearchBlockStyle>
		);
